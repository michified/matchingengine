...
* **Cache Topology Limits:** As the engine processes the lower-volume asset classes (approaching Company Rank 190+), minor L3 cache misses and branch predictor rhythm changes occur, introducing a step-up in cumulative P95 and P99.9 latencies.
